...
**Contributors**:
- Leader: Nguyễn Lê Phong - 23521168 - [Github](https://github.com/kllp031)
- Member: Quách Bùi Toàn Khoa - 23520754 - [Github](https://github.com/ToanfKhoa)
- Member: Nguyễn Thanh Vũ - 23521811 - [Github](https://github.com/NguyenThanhVu028)
...
1. **Prerequisites**
   - Unity Hub installed.
   - Unity Editor version **6000.1.8f1** or higher.
   - .NET / C# support bundled with Unity
...
* **Assets (Art & Sound)**: Licensed under [CC BY-NC 4.0](http://creativecommons.org/licenses/by-nc/4.0/) (Non-commercial use only).
